...
DB::query("DROP TABLE ".DB::table('dsu_paulpromotionpro')."");
DB::query("DROP TABLE ".DB::table('dsu_paulpromotionprostats')."");
DB::query("DROP TABLE ".DB::table('dsu_paulpromotionprorc')."");
DB::query("DELETE FROM ".DB::table('common_cron')." WHERE name='PromotionProDailyUpdate'");
@unlink(DISCUZ_ROOT.'./source/include/cron/cron_dsu_paulpromotionpro_daily.inc.php');
$finish = TRUE;
?>