...
DROP TABLE IF EXISTS cdb_plugin_dsuamfzc;
CREATE TABLE cdb_plugin_dsuamfzc (
`rid` CHAR( 32 ) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci NOT NULL ,
`email` CHAR( 40 ) CHARACTER SET gb2312 COLLATE gb2312_chinese_ci NOT NULL ,
