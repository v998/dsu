...
DB::query("ALTER TABLE ".DB::table('forum_thread')." ADD paulissue_status INT(1) NOT NULL DEFAULT '0'");
DB::query("ALTER TABLE ".DB::table('forum_thread')." ADD paulissue_hide INT(1) NOT NULL DEFAULT '0'");
